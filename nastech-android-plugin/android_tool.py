"""
nastech-android tool — 38 android_* tool handlers + schemas.
...
Used by the plugin's __init__.py to register tools into nastech-agent
    ...
    try:
        ...
        try:
            ...
            return json.dumps(
                {
                    "status": "error",
                    "message": "android_relay module not found. Make sure nastech-android plugin is installed.",
                }
            )
