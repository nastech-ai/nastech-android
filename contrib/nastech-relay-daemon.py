#!/usr/bin/env python3
"""Standalone relay daemon for nastech-android. Runs the WebSocket relay persistently."""
...
logger = logging.getLogger("nastech-relay-daemon")
...
def main():
    ...
    if not pairing_code:
        logger.error(
            "ANDROID_BRIDGE_TOKEN not set. Set it in ~/.nastech/.env or environment."
        )
        sys.exit(1)
