 ...
 *  - [RelayClient]  — outbound WebSocket relay (the path NasTech drives the device through)
 *  - [configureRouting] in NasTechRouter.kt — the local ktor HTTP server on :8765
 *
    ...
    suspend fun dispatch(
        ...
        return when {
            ...
            method == "GET" && path == "/notifications" -> {
                ...
                val listenerRunning = NasTechNotificationListener.instance != null
                mapOf(
