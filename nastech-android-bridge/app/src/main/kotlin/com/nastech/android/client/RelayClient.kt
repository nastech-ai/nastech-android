...
/**
 * WebSocket client that connects OUT to the NasTech relay server.
...
object RelayClient {
    ...
    private const val PREFS_NAME = "nastech_bridge_prefs"
    ...
    fun disconnect() {
        ...
        scope = null
        isConnected = false
        NasTechAccessibilityService.instance?.stopForeground()
    ...
    private fun doConnect(serverUrl: String, pairingCode: String) {
        ...
        webSocket = client.newWebSocket(request, object : WebSocketListener() {
            ...
            override fun onOpen(webSocket: WebSocket, response: Response) {
                ...
                isConnected = true
                try {
                    NasTechAccessibilityService.instance?.startForeground()
