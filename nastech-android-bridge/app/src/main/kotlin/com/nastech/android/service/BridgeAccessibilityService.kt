...
class NasTechAccessibilityService : AccessibilityService() {

    companion object {
        private const val TAG = "BridgeA11yService"

        @Volatile
        var instance: NasTechAccessibilityService? = null
            private set
    }
    ...
    fun startForeground(includeMediaProjection: Boolean = false) {
        ...
        val channelId = "nastech_bridge_channel"
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val channel = android.app.NotificationChannel(
                ...
                description = "Keeps NasTech running"
            }
