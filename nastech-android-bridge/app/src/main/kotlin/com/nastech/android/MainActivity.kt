...
class MainActivity : Activity() {
    ...
    private fun setupPairingCode() {
        ...
        tvPairingCode.setOnClickListener {
            ...
            clipboard.setPrimaryClip(ClipData.newPlainText("NasTech pairing code", PairingManager.getCode()))
    ...
    private fun setupPermissions() {
        switchAccessibility.setOnCheckedChangeListener { _, isChecked ->
            if (isChecked && NasTechAccessibilityService.instance == null) {
    ...
    private fun updatePermissionSwitches() {
        ...
        switchAccessibility.isChecked = NasTechAccessibilityService.instance != null
    ...
    private fun updateStatus() {
        val serviceRunning = NasTechAccessibilityService.instance != null
